...
namespace NextProjectMVC.Models.Entities
{
    ...
    public partial class Project: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Group> Groups
        {
            get
            {
                if (_groups == null)
                {
                    _groups = new TrackableCollection<Group>();
                    _groups.CollectionChanged += FixupGroups;
                }
                return _groups;
            }
            set
            {
                if (!ReferenceEquals(_groups, value))
                {
                    ...
                    OnNavigationPropertyChanged("Groups");
                }
            }
        }
        private TrackableCollection<Group> _groups;
        ...
        private void FixupGroups(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (Group item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Groups", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Group item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Groups", item);
                    }
                }
            }
        }
